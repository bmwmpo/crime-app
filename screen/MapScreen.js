...
const MapScreen = () => {
  ...
  const [eventCoord, setCoord] = React.useState({
    latitude: 43.759,
    longitude: -79.571,
  });
  const [region_color, setColor] = React.useState([
    "rgba(255,138,142,0.3)",
    "rgba(250,228,62,0.3)",
    "rgba(55,255,41,0.3)",
    "rgba(41,137,255,0.3)",
  ]);
  ...
  const [Region_Obj, setObj] = React.useState([
    new Region(-1, "default_poly", 0, 0, 0, 0, 0, 0, 0, 0, 0, default_poly),
  ]);
